...
class FotosControllerTest < ActionController::TestCase
  ...
  test "should create foto" do
    assert_difference('Foto.count') do
      post :create, foto: { content: @foto.content, date: @foto.date, image: @foto.image, title: @foto.title, user_id: @foto.user_id, username: @foto.username }
    end
  ...
  test "should update foto" do
    patch :update, id: @foto, foto: { content: @foto.content, date: @foto.date, image: @foto.image, title: @foto.title, user_id: @foto.user_id, username: @foto.username }
    assert_redirected_to foto_path(assigns(:foto))
  end
